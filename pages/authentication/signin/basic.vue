            ...
            <div class="card border-0 mb-0">
              ...
              <div class="card-body px-lg-5 pt-0">
                ...
                <form role="form" class="text-start">
                  ...
                  <div>
                    <button class="btn bg-success w-100 mb-0 toast-btn text-white" type="button" data-target="dangerToast"
                  ...
                  <div>
                    <button class="btn bg-info w-100 mb-0 toast-btn text-white" type="button" data-target="dangerToast"
                      @click="navigateTo('/authentication/signup/basic')">
                      Signup
                    </button>
                  </div>
                </form>
