         ...
         <li class="nav-item">
            <sidenav-collapse collapse-ref="componentsExamples" nav-text="Components"
               ...
               <template>
                  <ul class="nav ms-4">
                     <li class="nav-item">
                        <a class="nav-link" href="https://www.creative-tim.com/learning-lab/vue/alerts/argon-dashboard/"
                           target="_blank">
                     ...
                     <li class="nav-item">
                        <a class="nav-link" href="https://www.creative-tim.com/learning-lab/vue/Avatar/argon-dashboard/"
                           target="_blank">
                           <span class="sidenav-mini-icon">A</span>
                     ...
                     <li class="nav-item">
                        <a class="nav-link" href="https://www.creative-tim.com/learning-lab/vue/badge/argon-dashboard/"
                           target="_blank">
                     ...
                     <li class="nav-item">
                        <a class="nav-link" href="https://www.creative-tim.com/learning-lab/vue/buttons/argon-dashboard/"
                           target="_blank">
                           <span class="sidenav-mini-icon">B</span>
                     ...
                     <li class="nav-item">
                        <a class="nav-link" href="https://www.creative-tim.com/learning-lab/vue/input/argon-dashboard/"
                           target="_blank">
                     ...
                     <li class="nav-item">
                        <a class="nav-link" href="https://www.creative-tim.com/learning-lab/vue/checkbox/argon-dashboard/"
                           target="_blank">
                     ...
                     <li class="nav-item">
                        <a class="nav-link" href="https://www.creative-tim.com/learning-lab/vue/progress/argon-dashboard/"
                           target="_blank">
                           <span class="sidenav-mini-icon">P</span>
                     ...
                     <li class="nav-item">
                        <a class="nav-link" href="https://www.creative-tim.com/learning-lab/vue/snackbar/argon-dashboard/"
                           target="_blank">
