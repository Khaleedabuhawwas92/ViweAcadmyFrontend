         ...
         <div id="navbar" class="mt-2 collapse navbar-collapse mt-sm-0 me-md-0 me-sm-4">
            ...
            <ul class="navbar-nav justify-content-end">
               <li class="nav-item d-flex align-items-center">
                  <NuxtLink to="/authentication/signin/basic" class="px-0 nav-link font-weight-bold" :class="
                     navStore.navFixed && !navStore.darkMode
                        ? 'opacity-8 text-dark'
                        : 'text-white'
                  " target="_blank">
               ...
               <li class="px-3 nav-item d-flex align-items-center">
                  <a class="p-0 nav-link" @click="toggleShowConfig">
                     <i class="fas fa-cog pe-2 cursor-pointer fixed-plugin-button-nav" :class="
